...
// select all data
const selectAll = async (id: number) => await data;
...
const selectTodos = async (userId: number) => {
...
const infoAboutUser = async (username: string) => {
